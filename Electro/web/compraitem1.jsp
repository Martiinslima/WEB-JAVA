    ...
    <body>
            ...
            <div id="top-header">
                <div class="container">
                    ...
                    <ul class="header-links pull-right">
                        ...
                        <li><a href="login.html"><i class="fa fa-user-o"></i> Minha Conta</a></li>
                    </ul>
                </div>
            </div>
            <!-- /TOP HEADER -->
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Produto</h3>
				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<div class="order-notes">
							<textarea class="input" placeholder="Anotações / Complementos"></textarea>
						</div>
						<!-- /Order notes -->
					</div>
...
<form class="form-horizontal" method="post" action="CadCompra">
    <div class="form-group">
    <label class="col-sm-2 control-label hor-form">Nome</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="nome" placeholder="Nome" readonly value="Samsung expert">
    </div>
  </div>
    ...
    <div class="form-group">
    <label class="col-sm-2 control-label hor-form">Quantidade</label>
    <div class="col-sm-10">
        <input type="number" class="form-control" name="quantidade" id="quantidade" placeholder="Quantidade" onchange="qntTot();">
    </div>
  </div>
    
  <div class="form-group">
    <label class="col-sm-2 control-label hor-form">Valor total</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" name="preco" id="qntTotal" value="2500" placeholder="Preco" readonly>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" value="Cadastrar">Cadastrar</button>
                ...
                var preco = 2500;
                var qntTotal = document.getElementById('qntTotal');
                
                qntTotal.value = quantidade * preco;
            }
                                            </script>
                                            <script>
            function multiplicar(){
            m1 = parseInt(document.getElementById("quantidade").value);
            r = 2500*m1;
            return r;
            }  
