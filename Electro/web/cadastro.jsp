...
<h3 id="forms-horizontal">Abra sua conta</h3>
<form class="form-horizontal" method="post" action="CadUsuario">
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">Nome</label>
    <div class="col-sm-10">
      ...
      <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">Endereço</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label hor-form">Senha</label>
    <div class="col-sm-10">
